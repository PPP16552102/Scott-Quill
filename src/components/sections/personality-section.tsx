...
const PersonalitySection = () => {
  ...
  return (
    <section
      id="personality"
      ref={containerRef}
      className="relative min-h-screen py-24 md:py-32 overflow-hidden bg-neutral-950"
    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div style={{ y: y1 }} className="space-y-8">
              ...
              >
                <motion.p variants={itemVariants} custom={1}>
                  我的性格大部分情况下不可能不会有固定的表现，如果中将需要量化评价的话，我属于
                  16 人格中较为稀有的 INFJ。
                </motion.p>
              ...
              <motion.div
                ...
                className="relative"
              >
                <blockquote className="relative z-10 rounded-2xl bg-linear-to-r from-emerald-950 to-blue-950 p-8 italic text-neutral-200 border-l-4 border-blue-700 shadow-lg">
                  "明明拿了反派的成长剧本，却依旧想成为正道的光。"
                </blockquote>
                <motion.div
                  className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-linear-to-r from-emerald-800/30 to-blue-800/30 blur-xl"
                ...
                />
                <motion.div
                  className="absolute bottom-0 left-0 -mb-4 -ml-4 h-24 w-24 rounded-full bg-linear-to-r from-emerald-800/30 to-blue-800/30 blur-xl"
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.8, 0.5],
                  }}
              ...
              <div>
                <motion.h4
                  ...
                  className="text-xl font-bold mb-10 text-neutral-100"
                >
                  INFJ 特质
                </motion.h4>
                <div className="space-y-4">
                  {Traits.map((trait, index) => (
                    ...
                    >
                      <div className="h-3 w-3 rounded-full bg-linear-to-r from-emerald-500 to-blue-500 mr-4" />
            ...
            <motion.div style={{ y: y2 }}>
              <div className="space-y-12">
                ...
                >
                  <h4 className="text-xl font-bold mb-6 text-center text-neutral-100">
                    INFJ 性格雷达图
                  </h4>
                      ...
                      <motion.polygon
                        ...
                        animate={
                          isInView
                            ? {
                                points:
                                  "100,30 150,45 170,100 150,155 100,170 50,155 30,100 50,45",
                                transition: {
                                  duration: 1.5,
                                  delay: 1,
                                  ease: "easeOut",
                ...
                >
                  <h4 className="text-xl font-bold mb-6 text-neutral-100">
                    INFJ 分布
                  </h4>
                  <div className="relative pt-8">
                    <div className="absolute top-0 left-0 w-full flex justify-between text-xs text-neutral-400">
                      <span>0%</span>
                      <span>1%</span>
                      <span>2%</span>
                      <span>3%</span>
                    </div>
                    <div className="h-16 bg-linear-to-r from-emerald-950 to-blue-950 rounded-lg relative">
                      <motion.div
                        initial={{ width: 0 }}
                        ...
                        className="absolute top-0 left-0 h-full bg-linear-to-r from-emerald-600 to-blue-700 rounded-lg opacity-80"
                      />
                      <motion.div
