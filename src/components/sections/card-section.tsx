import { CardItems, InfiniteMovingCards } from "../ui/infinite-moving-cards";
  ...
  const cardItems: CardItems[] = [
    {
      quote: "福建厦门， 厦门理工",
      name: "Scopter",
      title: "坐标与身份：福建厦门 | 厦门理工 | 1年经验",
    },
    {
      quote: "主攻前端 (Vue/React/Typescript)，心系 Rust/Golang 的未来。",
      name: "技术栈 (当前)：TypeScript, Vue.js, React.js",
      title: "技术栈 (未来)：Rust, Golang",
    },
    {
      quote: "Vscode用户兼插进开发爱好者",
      name: "开发工具：Vscode",
      title: "曾用工具：Jetbrain",
    },
    {
    ...
    },
    {
      ...
      name: "兴趣爱好：音游",
      title:
        "涉猎音游：Arcaea, Phigros, Muse Dash, osu!, Malody, pjsk, Rizline",
    },
    {
